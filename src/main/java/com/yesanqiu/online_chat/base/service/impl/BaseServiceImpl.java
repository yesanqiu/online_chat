package com.yesanqiu.online_chat.base.service.impl;

import com.yesanqiu.online_chat.base.dto.BaseDTO;
import com.yesanqiu.online_chat.base.page.PageList;
import com.yesanqiu.online_chat.base.page.Paginator;
...
public abstract class BaseServiceImpl<M extends Mapper<T>, T> implements BaseService<T> {
	...
	@Override
	public Map<String, Object> reflexObject(Object object) throws Exception {
